...
func TestInteropPlaintextFooter_NoKey_PartialColumnRead(t *testing.T) {
	...
	require.ErrorContains(t, err, "decryption key required for column schema.double_field")
}
...
func TestPlaintextFooterDefersUnreadEncryptedColumnRetrieverError(t *testing.T) {
	...
	require.ErrorContains(t, err, "retrieve column key for "+common.ParGoRootExName+".name")
}
