...
func main() {
	var err error
	fw, err := local.NewLocalFileWriter("/tmp/partial2_without_predefined_schema.parquet")
	if err != nil {
	...
	///read
	fr, err := local.NewLocalFileReader("/tmp/partial2_without_predefined_schema.parquet")
	if err != nil {
