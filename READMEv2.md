...
See the [v3 README](README.md#geoparquet-geospatial-logical-types) for detailed geospatial documentation.
...
* Use [converter.go](https://github.com/hangxie/parquet-go/blob/main/types/converter.go) for type conversion utilities
...
See the [v3 README](README.md#supported-sources) for source implementation details.
...
* [v3 README](README.md) - Current v3 documentation (includes file source and geospatial docs)
